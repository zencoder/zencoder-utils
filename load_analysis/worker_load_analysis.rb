...
#     scp ~/zen/zencoder-utils/load_analysis/worker_load_analysis.rb util2:
#     ssh util2 "cd /data/zencoder/current_db4; script/rails runner -e production ~/worker_load_analysis.rb $1 $2 $3 $4"
