...
set output 'vp9_lag0thru16_psnr.png'
...
plot 'vp9_lag0thru16.dat' every 12::0::204 using 2:8:xtic(2) with linespoints lw 2 lt 8 lc rgb "#0077CC" title "cpu-used=1", \
                       '' every 12::3::204 using 2:8:xtic(2) with linespoints lw 2 lt 7 title "cpu-used=2", \
                       '' every 12::6::204 using 2:8:xtic(2) with linespoints lw 2 lt 9 title "cpu-used=3", \
                       '' every 12::9::204 using 2:8:xtic(2) with linespoints lw 2 lt 2 title "cpu-used=4", \
...
plot 'vp9_lag0thru16.dat' every 12::2::204 using 2:8:xtic(2) with linespoints lw 2 lt 8 lc rgb "#0077CC" title "cpu-used=1", \
                       '' every 12::5::204 using 2:8:xtic(2) with linespoints lw 2 lt 7 title "cpu-used=2", \
                       '' every 12::8::204 using 2:8:xtic(2) with linespoints lw 2 lt 9 title "cpu-used=3", \
                       '' every 12::11::204 using 2:8:xtic(2) with linespoints lw 2 lt 2 title "cpu-used=4", \
